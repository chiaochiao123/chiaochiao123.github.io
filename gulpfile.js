...
gulp.task('optimizationIMG', () => {
  return gulp.src(['src/assets/img/**/*.png', 'src/assets/img/**/*.jpg','src/assets/img/**/*.gif'])
    .pipe(imagemin({
      progressive: true,
...
gulp.task('watch', function () {
  ...
  var imgWatcher = gulp.watch(['src/assets/img/**/*.png', 'src/assets/img/**/*.jpg','src/assets/img/**/*.gif'], gulp.parallel('optimizationIMG'));
